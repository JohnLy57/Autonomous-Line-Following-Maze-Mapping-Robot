...
void loop(void)
{
  ...
  // First, stop listening so we can talk. - redundant
  radio.stopListening();

  // This will block until complete - check if there is a non blocking option
  unsigned int data = (B00001111 * 256) + B00000011;
